...
<table class="list" width="1500">
	...
	<td width="20px">
		<a href="sort.jsp?sort=wnum"> No </a></td>
	<td width="170px">
		<a href="sort.jsp?sort=title"> 제목 </a></td>
	<td width="70px">
		<a href="sort.jsp?sort=writer"> 작성자 </a></td>
...
<%
	...
	<tr height="50px" align="center">
 		...
 		<td class="lineB" width="40px"> <%=wrBean.getLook() %> </td>
 		<td class="lineB" width="40px"> <%=wrBean.getrNum()%> </td>
